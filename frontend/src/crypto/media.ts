export const mediaEncryption = {
  encrypt: async (file: File, cek: CryptoKey): Promise<{ encryptedBlob: Blob; iv: Uint8Array<ArrayBuffer> }> => {
  ...
  decrypt: async (encryptedBlob: Blob, cek: CryptoKey, iv: Uint8Array<ArrayBuffer>): Promise<Blob> => {
